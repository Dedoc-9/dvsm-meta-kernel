...
//
// In this DVSM v1b implementation, the "energy harvesting" occurs through the harvest_workload function.
// In this specific mathematical context, it refers to capturing the computational work or "tension" generated by the non-linear interaction between the system's attractor and repulsor
//
let tension = qabs(attractor - repulsor);
let work = qmul(tension, state.dt);
let scaled = work >> 8;
